        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex">
              <Button
                variant="ghost"
                className="mr-2 hover:bg-gray-100 hover:text-gray-900"
              >
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button
                    variant="outline"
                    size="lg"
                    className="border-gray-200 text-gray-900 hover:bg-gray-100 hover:text-gray-900"
                  >
                    Learn More
                  </Button>
                </div>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3">
              <div className="grid gap-4 text-center">
                ...
                <p className="text-gray-600">
                  Connect with brands based on audience demographics, engagement
              ...
              <div className="grid gap-4 text-center">
                ...
                <p className="text-gray-600">
                  Find and partner with creators who have complementary
                  audiences and content niches.
                </p>
              </div>
              <div className="grid gap-4 text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-full bg-purple-100 mx-auto">
                ...
                <p className="text-gray-600">
                  Get fair sponsorship pricing recommendations based on
              ...
              <div className="grid gap-4 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900">
                  Negotiation & Contract Assistant
                </h3>
                <p className="text-gray-600">
                  Structure deals, generate contracts, and optimize terms using
                  AI insights.
                </p>
              </div>
              <div className="grid gap-4 text-center">
                ...
                <p className="text-gray-600">
                  Track sponsorship performance, audience engagement, and
                  campaign success.
                </p>
              </div>
              <div className="grid gap-4 text-center">
                ...
                <p className="text-gray-600">
                  Measure and optimize return on investment for both creators
                  and brands.
                </p>
              </div>
            </div>
